...
class ActionPlan:
    ...
    @staticmethod
    def delete_file(path: str, reason: str, force: bool = False) -> None:
        """
        ...
        if not is_safe and not force:
            ...
            raise SafetyError(f"SAFETY BLOCK: Cannot delete sensitive file '{path}' without force=True. Reason: {reason}")
